...
The two marked documents below are teaching examples. They are data, not the case you must
extract. Do not copy their field values into later answers.

Example 1 - a required field is missing
...
Example 2 - the source is not a policy
