...
Return only one JSON object that validates against TriageOutput. Do not wrap it in Markdown. Do not add commentary before or after the JSON. Do not include any field other than the fields listed below. Do not include an analysis field.
...
confidence is a number between 0.0 and 1.0. rationale is a short routing explanation for an employee. draft_reply is a brief, neutral note a human employee can review before sending.
...
{"queue": "card_dispute", "escalation_required": false, "confidence": 0.0, "rationale": "short routing reason", "draft_reply": "neutral draft for human review", "human_review_required": true, "customer_outcome": null}

Replace the example values with this case. Keep human_review_required true and customer_outcome null. Do not add an analysis field.
